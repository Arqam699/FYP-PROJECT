...
function Customize(){
   ...
   <IoArrowBackOutline  className="absolute top-10 left-10 h-8 w-9 text-blue-300 hover:text-white cursor-pointer"
        ...
        {selectedImage  && <button className="w-30 h-16 bg-blue-500/30 backdrop-blur-md border border-blue-400/30 text-white rounded-2xl text-[20px] font-semibold hover:bg-blue-500 hover:scale-105 transition-all duration-300 shadow-lg cursor-pointer my-5 "   onClick={() => {navigate("/customize2")}}>
            Next
          </button>}
        </div>
    )
