...
function Customize(){
    ...
    return(
        <div className="w-full h-[100vh] bg-gradient-to-t from-[black] to-[#0d0da3] flex flex-col justify-center items-center ">
            <h1 className="text-[40px] text-white text-center my-4">Select you <span className="text-blue-300 text-center">Assistant Image</span></h1>
        ...
        {selectedImage  && <button className="w-30 h-16 bg-blue-400 text-white rounded-full text-[20px] font-bold hover:bg-blue-600 transition duration-300 cursor-pointer my-5 ">Next</button>}
        </div>
    )
}
